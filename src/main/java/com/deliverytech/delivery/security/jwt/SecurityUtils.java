...
if (authentication != null && authentication.getPrincipal() instanceof UserDetails) { return (Usuario) authentication.getPrincipal();
}
...
public static Long getCurrentRestauranteId() { Usuario usuario = getCurrentUser();
return usuario.getRestauranteId();
}


public static boolean hasRole(String role) { try {
