...
class EnderecoServiceImplTest {
    ...
    void buscarPorUsuarioLogado_DeveRetornarListaDeEnderecos() {
        ...
        when(enderecoRepository.findByUsuarioId(usuarioLogadoId)).thenReturn(listaDeEnderecosMock);
        ...
        verify(enderecoRepository, times(1)).findByUsuarioId(usuarioLogadoId); // Verifica se o repo foi chamado
    }
